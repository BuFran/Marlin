...
#define STRING_CONFIG_H_AUTHOR "Computer Laboratory" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Rebel 2"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 3200, 145}  // default steps per unit for Ultimaker
